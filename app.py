import eventlet # <--- ADDED: Imports the asynchronous library
eventlet.monkey_patch() # <--- ADDED: Patches standard Python libraries for non-blocking I/O
...
# Note: eventlet.wsgi must be imported after eventlet.monkey_patch()
from eventlet import wsgi # <--- ADDED: For a robust local server
...
# MODIFIED: Removed async_mode='threading'. SocketIO will now auto-detect and use eventlet.
...
# 2. OPTION B: Load from Environment (PowerShell)
...
VIDEO_OPTIONS = {
                  ...
                  'j_collage': 'https://greenmeadowcoc.com/wp-content/uploads/2025/09/Trivia-Part-A-Intro-Video.mp4',
                  'elder_statesone': 'https://greenmeadowcoc.com/wp-content/uploads/2025/09/Trivia-Part-A-Intro-Video.mp4',
                  'TJ_newcareer': 'https://greenmeadowcoc.com/wp-content/uploads/2025/09/Trivia-Part-A-Intro-Video.mp4',
                  'special_guest': 'https://greenmeadowcoc.com/wp-content/uploads/2025/09/Trivia-Part-A-Intro-Video.mp4',        
                  'none': None
}
...
if __name__ == '__main__':
                  ...
                  PORT = 5000
                  print("--- WebSocket Quiz Game Server (Eventlet Enabled) ---")
                  print(f"✅ Concurrency improved using **eventlet**.")
                  print(f"🌍 Open this URL in your browser(s): http://{local_ip}:{PORT}")
                  print(f"🔑 Host password is: 1234")
                  print("------------------------------------")
    # MODIFIED: Use eventlet's built-in server for better performance
